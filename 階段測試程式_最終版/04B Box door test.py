...
# ->速度控制器參數
POS_VEL_X_KP = 0.05             # 速度控制器X軸-P增益值
POS_VEL_X_KI = 0                # 速度控制器X軸-I增益值
POS_VEL_X_KD = 0                # 速度控制器X軸-D增益值
POS_VEL_Y_KP = 0.05             # 速度控制器Y軸-P增益值
...
SPD_KI = 0                      # I增益值*
SPD_KD = 0                      # D增益值*
SPD_ANGLE_LIMIT = 5             # 飛行速度控制器-最大俯仰角度(degree)
...
def position_velocity_controller():
    ...
    while STATE_THREAD:
        while MODE == 'POS' and STATE_THREAD:
            ...
            # ->速度控制器區塊B-控制器
            # 計算誤差值
            vel_error_x = TARGET_VEL[0] - ACTUAL_VEL[0]
            vel_error_y = TARGET_VEL[1] - ACTUAL_VEL[1]
        ...
        R_POS_TARGET_ROLL.append(0)
        R_POS_TARGET_PITCH.append(0)
        R_POS_ACTUAL_ROLL.append(0)
        R_POS_ACTUAL_PITCH.append(0)
