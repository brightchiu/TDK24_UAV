...
SPD_PITCH_OVER_WRITE = False    # Pitch覆寫旗標
SPD_KP = 8                      # P增益值*
SPD_KI = 0                      # I增益值*
SPD_KD = 0                      # D增益值*
...
# ->飛行程序參數
TAKEOFF_SETTLE = 90             # 安定高度百分比(%，高度確認門檻)*
...
T_RED_ARRIVE_LIMIT = 3000       # T字路口離開條件(px，紅色線條面積)
...
ANG_LINE_TRACK_AREA_H = 6000    # 線追蹤型心計算面積下限(僅限制角度輸出)
