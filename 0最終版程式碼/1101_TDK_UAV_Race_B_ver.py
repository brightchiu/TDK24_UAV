...
# ->線角度計算
# Gray色域調整法
ANG_THRESHOLD = 35              # 二值化門檻值(調高比較能看到線，但可能有雜訊) X
ANG_THRESHOLD_NEW = 255         # 取得黑白照填入最高值  X
ANG_GB_KERNEL_SIZE = (7, 7)     # 高斯模糊矩陣大小(奇數，越大越模糊)  X
ANG_GB_SIGMA = 2                # 高斯模糊色域標準差(越大越模糊)  X
# HSV色域調整法(其他參照)
ANG_LINE_TRACK_AREA_L = 4000    # 線追蹤型心計算面積下限*
ANG_LINE_TRACK_AREA_H = 15000   # 線追蹤型心計算面積下限(僅限制角度輸出)
